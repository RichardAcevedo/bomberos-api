...
class EmergencyExport implements FromCollection, WithCustomStartCell,
    Responsable, WithHeadings, ShouldAutoSize, WithEvents
{
    ...
    */
    private $fileName = 'Reporte de Emergencias.xlsx';
    ...
    */
    ...
    public function headings(): array
    {
        return [
            ...
            [
                'ID', 'ID MINUTA', 'TIPO DE EMERGENCIA', 'ESTADO', 'DESCRIPCION', 'FECHA DE REGISTRO'
            ]
        ];
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class    => function(AfterSheet $event) {
                ...
                $filas = DB::table('emergency')->get(); // Modelo especifico
