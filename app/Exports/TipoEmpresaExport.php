...
class TipoEmpresaExport implements FromCollection, WithCustomStartCell,
    Responsable, WithHeadings, ShouldAutoSize, WithEvents
{
    ...
    */
    private $fileName = 'Tipos de empresas.xlsx';
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class    => function(AfterSheet $event) {
                ...
                $filas = TipoEmpresa::all(); // Modelo especifico
    ...
    */
    public function collection()
    {
        ...
        foreach ($tiposEmpresa as $tipoEmpresa) {
            // ocultar
            unset($tipoEmpresa->created_at);
            unset($tipoEmpresa->updated_at);
        }
        return $tiposEmpresa;
    }
}
