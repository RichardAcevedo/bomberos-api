...
class TipoVehiculoExport implements FromCollection, WithCustomStartCell,
    Responsable, WithHeadings, ShouldAutoSize, WithEvents
{
    ...
    */
    private $fileName = 'Tipos de vehiculos.xlsx';
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class    => function(AfterSheet $event) {
                ...
                $filas = TipoVehiculo::all(); // Modelo especifico
    ...
    */
    public function collection()
    {
        ...
        foreach ($tiposVehiculo as $tipoVehiculo) {
            // ocultar
            unset($tipoVehiculo->created_at);
            unset($tipoVehiculo->updated_at);
        }
