...
class TipoExtintorExport implements FromCollection, WithCustomStartCell,
    Responsable, WithHeadings, ShouldAutoSize, WithEvents
{
    ...
    */
    private $fileName = 'Tipos de extintores.xlsx';
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class    => function(AfterSheet $event) {
                ...
                $filas = TipoExtintor::all(); // Modelo especifico
    ...
    */
    ...
    {
        $tiposExtintor = TipoExtintor::all();
        foreach ($tiposExtintor as $tipoExtintor) {
            // ocultar
            unset($tipoExtintor->created_at);
            unset($tipoExtintor->updated_at);
        }
