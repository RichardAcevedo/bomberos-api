...
class EmergenciaExport implements FromCollection, WithCustomStartCell,
    Responsable, WithHeadings, ShouldAutoSize, WithEvents
{
    ...
    */
    private $fileName = 'Emergencias.xlsx';
    ...
    */
    ...
    public function headings(): array
    {
        return [
            ...
            [
                'ID', 'TELEFONO', 'ENTIDAD', 'DIRECCION', 'BARRIO', 'OTRO TELEFONO', 'EXTENSION'
            ]
        ];
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class    => function(AfterSheet $event) {
                ...
                $filas = Emergencia::all(); // Modelo especifico
    ...
    */
    public function collection()
    {
        ...
        foreach ($emergencias as $emergencia) {
            // ocultar
            unset($emergencia->created_at);
            unset($emergencia->updated_at);
        }
        return $emergencias;
    }
}
