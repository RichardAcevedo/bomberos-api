...
class ElementoExport implements FromCollection, WithCustomStartCell,
    Responsable, WithHeadings, ShouldAutoSize, WithEvents
{
    ...
    */
    private $fileName = 'Elementos.xlsx';
    ...
    */
    ...
    public function headings(): array
    {
        return [
            ...
            [
                'ID', 'CODIGO INVENTARIO', 'NOMBRE', 'DESCRIPCION'
            ]
        ];
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class    => function(AfterSheet $event) {
                ...
                $filas = Elemento::all(); // Modelo especifico
    ...
    */
    public function collection()
    {
        ...
        foreach ($elementos as $elemento) {
            // ocultar
            unset($elemento->created_at);
            unset($elemento->updated_at);
        }
        return $elementos;
    }
}
