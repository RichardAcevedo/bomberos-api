...
class RadioExport implements FromCollection, WithCustomStartCell,
    ...
    */
    ...
    public function headings(): array
    {
        return [
            ...
            [
                'ID', 'SERIAL', 'MARCA', 'ESTADO', 'SEÑAL', 'TIPO', 'VEHICULO'
            ]
        ];
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class    => function(AfterSheet $event) {
                ...
                $filas = Radio::all(); // Modelo especifico
    ...
    */
    public function collection()
    {
        ...
        foreach ($radios as $radio) {
            ...
            $radio->vehiculo = $vehiculo->nombre;
            unset($radio->id_vehiculo);
            // ocultar
            unset($radio->created_at);
            unset($radio->updated_at);
        }
        return $radios;
    }
}
