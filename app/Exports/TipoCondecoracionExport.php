...
class TipoCondecoracionExport implements FromCollection, WithCustomStartCell,
    Responsable, WithHeadings, ShouldAutoSize, WithEvents
{
    ...
    */
    private $fileName = 'Tipos de condecoraciones.xlsx';
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class    => function(AfterSheet $event) {
                $headerRange = 'A2:B2'; // All headers (Ver hasta donde va cada archivo)
                // titulo en negrita:
                ...
                $filas = TipoCondecoracion::all(); // Modelo especifico
    ...
    */
    ...
    {
        $tiposCondecoracion = TipoCondecoracion::all();
        foreach ($tiposCondecoracion as $tipoCondecoracion) {
            // ocultar
            unset($tipoCondecoracion->created_at);
            unset($tipoCondecoracion->updated_at);
        }
        return $tiposCondecoracion;
    }
}
